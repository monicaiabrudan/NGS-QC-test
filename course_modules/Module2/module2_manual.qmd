...
On completion of the tutorial, you can expect to be able to: ● Understand the background and theory of read alignment ● Perform read alignment using standard tools (BWA-MEM)
...
![**The Smith Waterman algorithm**](images/smith waterman.png){width="378"}
...
![](images/high divergence1.png){width="425"}

![](images/high divergence2.png){width="451"}
...
![](images/alignment challenges.png)
...
![**Data production workflow**](images/data production workflow.png)
...
![**Duplicates and false SNPs**](images/duplicates and false SNPs.png)

...
![**Reference based compression**](images/reference based compression1.png){width="472"}

![**Reference based compression**](images/reference based compression2.png){width="473"}
...
![**Mean base quality**](images/base quality.png){width="336"}
...
![**Base quality**](images/base quality2.png){width="438"}
...
![**Base calling errors**](images/base calling errors.png){width="501"}
...
![Missmatches per cycle](images/missmatches per cycle.png){width="536"}
...
![**GC content**](images/gc content.png){width="497"}
...
![**GC content by cycle**](images/GC content by cycle.png){width="542"}
...
![**Fragment size distribution**](images/fragment size distribution.png)

**Q1: The figure below is from a 100bp paired-end sequencing. Can you spot any problems?**

![**Insert size**](images/insert size.png){width="490"}
...
![**Indels per cycle**](images/indels per cycle.png){width="415"}
